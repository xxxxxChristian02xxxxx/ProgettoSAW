...
$query = "SELECT STUDY_SESSIONS.SESSION_ID, STUDY_SESSIONS.TYPE, STUDY_SESSIONS.DATE, STUDY_SESSIONS.TOTAL_TIME, STUDY_SESSIONS.TOTAL_REWARD, SUBJECTS.NAME, STUDY_SESSIONS.DESCRIPTION 
          FROM STUDY_SESSIONS 
